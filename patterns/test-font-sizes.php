...
<?php
  /**
   * Title: A section to test font sizes
   * slug: kide/test-font-sizes
   * Categories: text
   * */
?>
...
<div class="wp-block-group">
  ...
  <div class="wp-block-group kide-test-font-container">
    ...
    <!-- wp:heading {"level":1,"fontSize":"7-xl"} -->
    <h1 class="has-7-xl-font-size" id="h1-7xl-otsikko">H1 7XL Otsikko potsikko pusikko asiaton loton poton pytyn</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:heading {"level":1,"fontSize":"6-xl"} -->
    <h1 class="has-6-xl-font-size" id="h1-6xl-otsikko">H1 6XL Otsikko potsikko pusikko asiaton loton poton pytyn</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:heading {"level":1,"fontSize":"5-xl"} -->
    <h1 class="has-5-xl-font-size" id="h1-5xl-otsikko">H1 5XL Otsikko potsikko pusikko asiaton loton poton pytyn</h2>
    <!-- /wp:heading -->
