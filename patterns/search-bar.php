...
<!-- wp:group {"backgroundColor":"dark-4","layout":{"type":"constrained"}} -->
<div id="kide-search-bar" class="wp-block-group has-dark-4-background-color has-background">
  ...
  <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
    <!-- wp:search {"showLabel":false,"placeholder":"Hae...","width":null,"widthUnit":"%","buttonText":"Etsi","buttonUseIcon":true,"backgroundColor":"dark-8","textColor":"light-4","className":"kide-header-search"} /-->
  </div>
  <!-- /wp:group -->
</div>
<!-- /wp:group -->